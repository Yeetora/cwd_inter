...
export const metadata: Metadata = { title: "주거공간 | Project" };
...
export default async function ResidentialPage({
  ...
  const data = await publicApi.listPortfolios("RESIDENTIAL", page, 12);

  return (
    <div className="mx-auto max-w-7xl px-4 py-20 md:px-8 md:py-28">
      <div className="flex items-end justify-between">
        <div>
          <p className="text-xs tracking-[0.3em] text-muted">RESIDENTIAL</p>
          <h1 className="mt-4 text-3xl font-light md:text-4xl">주거공간</h1>
        </div>
        <Link
